package com.inMotion.ui.activities.login;
...
import com.inMotion.ui.activities.registration.RegistrationActivity;


/**
 * A login screen that offers login via email/password.
 */
public class LoginActivity extends BaseAppCompatActivity implements LoaderCallbacks<Cursor>, IContextDelegate {
    ...
    protected int getLayoutView() {
        return R.layout.inmotionui_login;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doSignin.setOnClickListener(new OnClickListener() {
            @Override
        ...
        doRegister.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                moveToActivity(RegistrationActivity.class);
            }
        });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Context.getCurrent().login(new User(email), password);
        }
    }
